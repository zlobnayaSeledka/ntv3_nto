...
class SomethingWrongPage extends StatelessWidget {
  const SomethingWrongPage({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Center(
          child: Column(
            ...
            children: [
              const CustomTitleText(text: 'Что-то пошло не так..', size: 30,),
              const SizedBox(height: 16),
              const CustomTitleText(text: 'Попробуйте войти снова', size: 25),
              const SizedBox(height: 16),
              CustomFilledButton(
